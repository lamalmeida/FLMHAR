...
def train_step(encoders, final_classifier, optimizer, data, labels, device):
...
def validation_step(encoders, final_classifier, data, labels, val_metrics, device):
    for mod in encoders.keys():
        encoders[mod].eval()
...
def train_features_fusion(encoders, final_classifier, optimizer, train_loader, val_loader, args):
    ...
    for epoch in range(args.classification_epochs):
        ...
        while True:
            ...
            try:
                ...
                total_loss.append(train_step(encoders, final_classifier, optimizer, train_data, train_label, args.device))
        ...
        if (epoch + 1) % 1 == 0:
            ...
            while True:
                ...
                try:
                    ...
                    val_loss.append(validation_step(encoders, final_classifier, val_data, val_label, val_metrics, args.device))
