...
def get_args():
    ...
    parser.add_argument('--modalities', type=str, default='rgb|lidar|mmwave|wifi-csi', help='Sensor modalities to use (rgb|lidar|mmwave|wifi-csi)')
    ...
    parser.add_argument('--dropout', type=float, default=0.4, help='Dropout for transformer encoders')

    # Encoder training arguments
    parser.add_argument('--batch_size', type=int, default=64, help='Batch size for training')
    parser.add_argument('--contrastive_epochs', type=int, default=100, help='Number of training epochs')
    ...
    parser.add_argument('--classification_learning_rate', type=float, default=0.01, help='Learning rate')
    parser.add_argument('--classification_epochs', type=int, default=100, help='Number of training epochs')
